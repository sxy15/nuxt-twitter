<template>
    <div class="flex flex-col">
        ...
        <!-- Search bar -->
        <div class="relative m-2 flex item-center">
            ...
            <input v-model="search"
                class="flex items-center w-full pl-12 text-sm font-normal text-black border border-solid border-gray-200 rounded-full dark:text-gray-100 dark:bg-dim-400 dark:border-dim-400 focus:bg-gray-100 dark:focus:bg-dim-900 focus:outline-none focus:border focus:border-blue-200 h-9"
        ...
        <SidebarRightPreviewCard title="What's happening">
            ...
            <SidebarRightPreviewCardItem v-for="whatsHappening in whatsHappeningItems">
                <div>
                    <div class="font-bold text-gray-800 text-md dark:text-white">{{ whatsHappening.title }}</div>
                ...
                <div class="flex flex-row items-center justify-between p-2">
                    <div class="flex flex-row">
                        ...
                        <div class="flex flex-col ml-2">
                            <div class="text-sm font-bold text-gray-900 dark:text-white">{{ whoToFollow.name }}</div>
